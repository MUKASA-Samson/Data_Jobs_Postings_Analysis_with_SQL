...
The insights show that Data Analysts are leading as highly demanded Data Professionals while Senior Data Scientists earn the highest average salary among Data roles. Cloud Engineering rank the least in terms of demand but has fair yearly salary average.
![Highly Demanded Roles](Vizzes/Data-Roles-Demand-and-Salary.png)
...
![Top Paying Skills](Vizzes/High-Paying-Skills.png)
...
![Highly Demanded Skills](Vizzes/Highly-Demanded-Skills.png)
...
I used CTEs and joined them to get the list of in demand skills as well as their average salary. 
[Click Here to access the query](Queries/4_Optimal_Skills_for_DA.sql)

![Optimal Skills to Learn](Vizzes/Optimal-Skills.png)
...
Query
```sql
--Cleaning, analysing, and filtering Job Postings Platforms--
SELECT 
   CASE
		WHEN job_via LIKE ('%Linked%') THEN 'LinkedIn'
		WHEN job_via NOT LIKE ('%Linked%') THEN TRIM(RIGHT(job_via,-3))
...
```
Results
![Job Platforms](Vizzes/Platforms.png)
...
![Dashboard](Vizzes/Dashboard.png)
